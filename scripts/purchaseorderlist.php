...
$columns = array(
	...
	array( 'db' => '`uf`.`contact_person`', 'dt' => 'contact_person', 'field' => 'contact_person' ),
	array(
	'db' => "CONCAT(
		CASE 
