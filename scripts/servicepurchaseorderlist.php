...
$columns = array(
	...
	array( 'db' => '`u`.`servicepo_confirm`', 'dt' => 'servicepo_confirm', 'field' => 'servicepo_confirm' ),
	array( 'db' => '`u`.`tbl_material_group_idtbl_material_group`', 'dt' => 'tbl_material_group_idtbl_material_group', 'field' => 'tbl_material_group_idtbl_material_group' ),
	...
	'db' => "CONCAT(
		CASE 
			WHEN `u`.`servicepo_confirm` = 1 THEN '<i class=\"fas fa-check text-success mr-2\"></i>Confirm PO'
			WHEN `u`.`servicepo_confirm` = 2 THEN '<i class=\"fa fa-times text-danger mr-2\"></i>Reject PO'
...
$extraWhere = "`u`.`status` IN (1,2) AND `u`.`tbl_company_idtbl_company`='$companyID' AND `u`.`tbl_material_group_idtbl_material_group`= 4";
