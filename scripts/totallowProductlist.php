...
$extraWhere = "`u`.`tbl_print_material_info_idtbl_print_material_info` <> 0 AND `u`.`qty` < `ua`.`reorderlevel` AND `u`.`status` IN (1, 2) AND `u`.`tbl_company_idtbl_company`='$companyid'";
