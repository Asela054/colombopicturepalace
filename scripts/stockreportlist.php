...
$joinQuery = "FROM `tbl_print_stock` AS `u` LEFT JOIN `tbl_print_material_info` AS `ua` ON (`ua`.`idtbl_print_material_info` = `u`.`tbl_print_material_info_idtbl_print_material_info`) LEFT JOIN `tbl_material_type` AS `ub` ON (`ub`.`idtbl_material_type` = `ua`.`tbl_material_type_idtbl_material_type`)";
