...
<head>
	...
	<title><?php echo !empty($_SESSION['companyname']) ? $_SESSION['companyname'] : 'Printing Job Management Portal' ?> - By Erav Technology</title>
	...
	<link rel="icon" type="image/x-icon" href="<?php echo base_url() ?>images/pictures.png" />
