                            ...
                            <div class="col-3">
                                <form action="<?php echo base_url() ?>User/Userprivilegeinsertupdate" method="post" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" value="1" id="checkstatus" name="checkstatus">
            ...
            if (r == true) {
                ...
                $.ajax({
                    ...
                    success: function(result) { //alert(result);
                        ...
                        if(obj.approvestatus==1){$('#approvecheck').prop('checked', true);}
                        if(obj.checkstatus==1){$('#checkstatus').prop('checked', true);}
