...
class Materialgroupinfo extends CI_Model{
    ...
    public function Materialgroupinsertupdate(){
        ...
        if($recordOption==1){
            ...
            $this->db->insert('tbl_material_group', $data);
            ...
            $this->db->where('idtbl_material_group', $recordID);
            $this->db->update('tbl_material_group', $data);
    ...
    public function Materialgroupedit(){
        ...
        $obj=new stdClass();
        $obj->id=$respond->row(0)->idtbl_material_group;
        $obj->group=$respond->row(0)->group;
