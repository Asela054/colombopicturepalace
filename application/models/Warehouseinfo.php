<?php
class Warehouseinfo extends CI_Model{
    public function Warehouseinsertupdate(){
        ...
        if($recordOption==1){
            ...
            $this->db->where('idtbl_warehouse', $recordID);
    ...
    public function Warehouseedit(){
        ...
        $obj=new stdClass();
        $obj->id=$respond->row(0)->idtbl_warehouse;
        $obj->warehouse=$respond->row(0)->wh_name;
        $obj->binno=$respond->row(0)->binno;
