<?php
class Colorinfo extends CI_Model{
    public function Colorinsertupdate(){
		...
		$squarinchcost=$this->input->post('squarcost');
        ...
        if($recordOption==1){
            ...
            $this->db->where('idtbl_color', $recordID);
    ...
    public function Coloredit(){
        ...
        $obj=new stdClass();
        $obj->id=$respond->row(0)->idtbl_color;
        $obj->color=$respond->row(0)->color;
		$obj->description=$respond->row(0)->description;
		$obj->unitprice=$respond->row(0)->unitprice;
		$obj->squarprice=$respond->row(0)->squarinch_cost;
